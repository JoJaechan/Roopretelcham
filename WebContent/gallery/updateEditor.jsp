...
<body>
	...
	location.href="/member/login.jsp";</script>
		...
		bb = bdao.getArticle(num, Table.BOARD_GALLERY.name());
			...
			<form action="/BoardUpdate" method="POST" name="content_form">
				<table id="gallery" style="width: 100%;">
					<tr>
						...
						<td><input type="hidden" name="tableName" value="<%=Table.BOARD_GALLERY.name()%>" readonly></td>
					</tr>
					<!-- 					<tr> -->
					<!-- 						<td>비밀번호</td> -->
					...
					<tr>
						<td style="width: 100%;"><input type="text" maxlength="50" width="100%" style="width: 100%;"
